  ...
  return (
    <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, i) => (
            <motion.div 
              ...
              transition={{ delay: i * 0.1 }}
              className="group bg-white p-4 md:p-8 rounded-3xl border border-slate-200 hover:border-blue-500 transition-all hover:shadow-xl"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-4 md:p-8 rounded-3xl border border-slate-200">
        ...
        <div className="bg-slate-900 p-4 md:p-8 rounded-3xl text-white">
